...
<form action="registerAction" method="post" >
	...
	<input class="form-control" type="text" name="First_name" placeholder="First Name" required minlength="3" maxlength="25" data-inputmask-regex="[A-Za-z]*" ><br>
	</div>
	<div class="form-group">
	<label for="FName">Last Name</label>
	<input class="form-control" type="text" name="Last_name" placeholder="Last Name" required minlength="3" maxlength="25" data-inputmask-regex="[A-Za-z]*" ><br>
	</div>
	<div class="form-group">
	...
	<input class="form-control" type="number" name="mobile" placeholder="Mobile Number" min="1000000000" max="9999999999"><br>
	</div>
	<div class="form-group">
	...
	<br>
	<input type="checkbox" > <a href="#">Click to agree on Terms and Conditions</a>
	<br>
	<br>
